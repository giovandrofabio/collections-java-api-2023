...
public class AgendaEventos {
    ...
    public static void main(String[] args) {
        ...
        //agendaEventos.adicionarEvento(LocalDate.of(2023, Month.NOVEMBER, 20),"Evento 4","Atração 4");
        agendaEventos.adicionarEvento(LocalDate.of(2023, Month.NOVEMBER, 21),"Evento 5","Atração 5");
